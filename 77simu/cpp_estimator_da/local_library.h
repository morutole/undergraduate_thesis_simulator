...
using Matrix13d = Matrix<double, 13, 13>;
using Vector6d = Matrix<double, 6, 1>;
using Vector13d = Matrix<double, 13, 1>;
...
const double position_noise = 0.5; //位置に乗るノイズ[m]
const double velocity_noise = 5e-2; //速度に乗るノイズ[m/s]
const double acceleration_noise = 5e-3; //加速度に乗るノイズ[m/s^2] TBD
const double daccel_noise = 5e-4;
